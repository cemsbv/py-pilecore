...
class PileType:
    ...
    def from_api_response(cls, pile_type: dict) -> PileType:
        ...
        return cls(
            ...
            qc_z_a_lesser_1m=pile_type["properties"]["qc_z_a_lesser_1m"],
            qc_z_a_greater_1m=pile_type["properties"]["qc_z_a_greater_1m"],
            qb_max_limit=pile_type["properties"]["qb_max_limit"],
        )
