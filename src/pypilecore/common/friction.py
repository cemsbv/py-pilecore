...
class FrictionSettings:
    def __init__(self, 
                 friction_range_strategy: str | FrictionRangeStrategy = FrictionRangeStrategy.lower_bound, 
        ...
        assert any(item.value == friction_range_strategy for item in FrictionRangeStrategy), f"Invalid value for friction_range_strategy defined, please enter one of {[item.value for item in FrictionRangeStrategy]}"
